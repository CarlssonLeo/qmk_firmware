 ...
 */
    [_SYM] = LAYOUT(
     _______, _______, SE_AT ,  SE_LCBR , SE_RCBR, SE_PIPE,                                     S(SE_SECT), SE_EQL , SE_SECT, SE_DQUO, _______, SE_BSLS,
     _______, SE_HASH, SE_DLR,  SE_LPRN , SE_RPRN, SE_GRV,                                      SE_PLUS, SE_MINS, SE_SLSH, SE_ASTR, SE_PERC, SE_QUOT,
     _______, SE_PERC, SE_CIRC, SE_LBRC,  SE_RBRC, SE_TILD, _______, _______, _______, _______, SE_AMPR, SE_EXLM, SE_QUES, _______,  _______, _______,
                                 _______, _______, _______, _______, _______, _______, _______, _______, _______, _______
    ),
